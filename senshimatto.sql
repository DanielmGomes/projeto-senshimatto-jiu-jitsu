...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 29-Ago-2020 às 01:52
...
CREATE TABLE IF NOT EXISTS `academia` (
  ...
  `cnpj` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `telefone` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `whatsaap` varchar(2) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'whatsapp sim ou nao',
...
INSERT INTO `academia` (`idacademia`, `cidade_idcidade`, `estado_idestado`, `nome`, `cnpj`, `endereco`, `bairro`, `responsavel`, `cpf`, `rg`, `telefone`, `whatsaap`, `email`) VALUES
(1, 6, 1, 'academia a', '11.111.111/1111-11', 'rua a ', 'bairro a', 'responsavel a', '111.111.111-11', '11.111.111', '(11) 1 1111-1111', NULL, 'academiaa@teste.com'),
(2, 5, 2, 'academia b', '11.111.111/1111-11', 'rua b', 'bairro b', 'responsavel b', '111.111.111-11', '11.111.111', '(11) 1 1111-1111', NULL, 'academiab@teste.com');
...
CREATE TABLE IF NOT EXISTS `administrativo` (
  ...
  `endereco` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bairro` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `numeroCartao` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nomeCartao` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `vencimentoCartao` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `codigoCartao` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `administrativo` (`idAdministrativo`, `cidade_idcidade`, `estado_idestado`, `nome`, `email`, `telefone`, `whatsapp`, `usuario`, `senha`, `endereco`, `bairro`, `numeroCartao`, `nomeCartao`, `vencimentoCartao`, `codigoCartao`) VALUES
(186, 1735, 11, 'daniel', 'danielmoreiragomes.dmg@gmail.com', '(35) 9 8825-0966', NULL, 'daniel', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'rua ipe rosa', 'vila verde I', NULL, NULL, NULL, NULL),
(187, 80, 1, 'daniel', 'danielmoreiragomes.dmg@gmail.com', '(99) 9 9999-9999', NULL, 'teste', '51eac6b471a284d3341d8c0c63d0f1a286262a18', 'rua a', 'bairro a', NULL, NULL, NULL, NULL),
(188, 80, 1, 'daniel', 'danielmoreiragomes.dmg@gmail.com', '(99) 9 9999-9999', NULL, 'teste', '51eac6b471a284d3341d8c0c63d0f1a286262a18', 'rua a', 'bairro a', NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `atleta` (
  ...
  `estado_idestado` int NOT NULL,
  `nome` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nascimento` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cpf` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sexo` varchar(2) COLLATE utf8_unicode_ci DEFAULT NULL,
  `email` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '* envio de notificações para o atleta\n* usuario do atleta',
  `telefone` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `whatsapp` varchar(2) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '* radiobutton sim ou não',
  `usuario` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `senha` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `foto` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `peso` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `idade` date DEFAULT NULL,
  `endereco` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bairro` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `faixa` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `numeroCartao` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nomeCartao` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `codigoCartao` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `vencimentoCartao` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`idatleta`),
  KEY `fk_atleta_academia1_idx` (`academia_idacademia`),
  KEY `cidade_idcidade` (`cidade_idcidade`),
  KEY `estado_idestado` (`estado_idestado`)
...
INSERT INTO `atleta` (`idatleta`, `academia_idacademia`, `cidade_idcidade`, `estado_idestado`, `nome`, `nascimento`, `cpf`, `sexo`, `email`, `telefone`, `whatsapp`, `usuario`, `senha`, `foto`, `peso`, `idade`, `endereco`, `bairro`, `faixa`, `numeroCartao`, `nomeCartao`, `codigoCartao`, `vencimentoCartao`) VALUES
(8, 0, 0, 0, '', '', '', '', 'danielmoreiragomes.dmg@gmail.com', '', NULL, 'daniel', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', NULL, '', NULL, '', '', '', NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `bolsacompeticao`
--

DROP TABLE IF EXISTS `bolsacompeticao`;
CREATE TABLE IF NOT EXISTS `bolsacompeticao` (
  `idbolsaCompeticao` int NOT NULL AUTO_INCREMENT,
  `inscricao_idInscricao` int NOT NULL,
  PRIMARY KEY (`idbolsaCompeticao`),
  KEY `fk_bolsaCompeticao_inscricao1_idx` (`inscricao_idInscricao`)
...
CREATE TABLE IF NOT EXISTS `cidade` (
  ...
  KEY `uf` (`uf`)
) ENGINE=MyISAM AUTO_INCREMENT=5611 DEFAULT CHARSET=utf8 COMMENT='Municipios das Unidades Federativas';

--
-- Extraindo dados da tabela `cidade`
--

INSERT INTO `cidade` (`idCidade`, `nome`, `uf`, `ibge`) VALUES
...
CREATE TABLE IF NOT EXISTS `competicao` (
  ...
  `cartaz` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`idCompeticao`),
  KEY `administrativo_idadministrativo` (`administrativo_idadministrativo`),
  KEY `cidade_idcidade` (`cidade_idcidade`),
  KEY `estado_idestado` (`estado_idestado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `estado` (`idEstado`, `nome`, `uf`, `ibge`, `pais`, `ddd`) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
CREATE TABLE IF NOT EXISTS `inscricao` (
  ...
  `valorInscricao` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `competirAbsoluto` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `fechamentoInscricao` date DEFAULT NULL,
  PRIMARY KEY (`idInscricao`),
  KEY `fk_inscricao_atleta_idx` (`atleta_idatleta`),
  KEY `competicao_idCompeticao` (`competicao_idCompeticao`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Estrutura da tabela `lutascasadas`
--

DROP TABLE IF EXISTS `lutascasadas`;
CREATE TABLE IF NOT EXISTS `lutascasadas` (
  `idlutasCasadas` int NOT NULL AUTO_INCREMENT,
  `inscricao_idInscricao` int NOT NULL,
  `placarLuta` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`idlutasCasadas`),
  KEY `fk_lutasCasadas_inscricao1_idx` (`inscricao_idInscricao`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pais` (
  ...
  PRIMARY KEY (`idPais`)
) ENGINE=MyISAM AUTO_INCREMENT=264 DEFAULT CHARSET=utf8 COMMENT='Países e Nações';
...
CREATE TABLE IF NOT EXISTS `professor` (
  ...
  `rg` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `telefone` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `whatsapp` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `email` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `faixa` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`idprofessor`),
  KEY `academia_idacademia` (`academia_idacademia`)
...
INSERT INTO `professor` (`idprofessor`, `academia_idacademia`, `cidade_idcidade`, `estado_idestado`, `nome`, `endereco`, `bairro`, `cpf`, `rg`, `telefone`, `whatsapp`, `email`, `faixa`) VALUES
(1, 1, 1, 8, 'professor a', 'rua a', 'bairro a', '111.111.111-11', '11.111.111', '(11) 11 1 1111-1111', '(11) 11 1 1111-1111', 'professora@email.com', 'preta'),
(2, 1, 1, 8, 'professor b', 'rua b', 'bairro b', '222.222.222-22', '22.222.222', '(22) 2 2222-2222', '(22) 2 2222-2222', 'professorb@email.com', 'branca'),
(3, 1, 1, 8, 'professor c', 'rua c', 'bairro c', '333.333.333-33', '33.333.333', '(33) 33 3 3333-3333', '(33) 33 3 3333-3333', 'professorc@email.com', 'azul'),
(4, 2, 1, 8, 'professor d', 'rua d', 'bairro d', '444.444.444-44', '44.444.444', '(44) 44 4 4444-4444', '(44) 44 4 4444-4444', 'professord@email.com', 'marron'),
(5, 2, 201, 2, 'professor e', 'rua e', 'bairro e', '555.555.555-55', '55.555.555', '(55) 55 5 5555-5555', '(55) 55 5 5555-5555', 'professore@email.com', 'roxa'),
(6, 2, 201, 2, 'professor f', 'rua f', 'bairro f', '666.666.666-66', '66.666.666', '(66) 66 6 6666-6666', '(66) 66 6 6666-6666', 'professorf@email.com', 'coral');
...
CREATE TABLE IF NOT EXISTS `ranking` (
  ...
  `lutasCasadas_idlutasCasadas` int NOT NULL,
  PRIMARY KEY (`idranking`),
  KEY `fk_ranking_lutasCasadas1_idx` (`lutasCasadas_idlutasCasadas`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Limitadores para a tabela `bolsacompeticao`
--
ALTER TABLE `bolsacompeticao`
  ADD CONSTRAINT `fk_bolsaCompeticao_inscricao1` FOREIGN KEY (`inscricao_idInscricao`) REFERENCES `inscricao` (`idInscricao`);

--
-- Limitadores para a tabela `competicao`
--
ALTER TABLE `competicao`
  ADD CONSTRAINT `competicao_ibfk_1` FOREIGN KEY (`administrativo_idadministrativo`) REFERENCES `administrativo` (`idAdministrativo`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Limitadores para a tabela `inscricao`
--
ALTER TABLE `inscricao`
  ADD CONSTRAINT `fk_inscricao_atleta` FOREIGN KEY (`atleta_idatleta`) REFERENCES `atleta` (`idatleta`),
  ADD CONSTRAINT `inscricao_ibfk_1` FOREIGN KEY (`competicao_idCompeticao`) REFERENCES `competicao` (`idCompeticao`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Limitadores para a tabela `lutascasadas`
--
ALTER TABLE `lutascasadas`
  ADD CONSTRAINT `fk_lutasCasadas_inscricao1` FOREIGN KEY (`inscricao_idInscricao`) REFERENCES `inscricao` (`idInscricao`);

--
-- Limitadores para a tabela `ranking`
--
ALTER TABLE `ranking`
  ADD CONSTRAINT `fk_ranking_lutasCasadas1` FOREIGN KEY (`lutasCasadas_idlutasCasadas`) REFERENCES `lutascasadas` (`idlutasCasadas`);
COMMIT;
