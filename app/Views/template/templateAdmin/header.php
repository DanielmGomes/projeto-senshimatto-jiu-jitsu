...
<html lang="en">
    <head>
        ...
        <!-- Font Awesome -->
        <link href="<?php echo base_url('restrict/css/font-awesome.min.css'); ?>" rel="stylesheet">
        <link href="<?php echo base_url('restrict/css/font-awesome.min.css'); ?>" rel="stylesheet">
        <!-- NProgress -->
                                ...
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-file-text"></i> Cadastros <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?php echo site_url('cadastro_competicao'); ?>">Competições</a></li>
                                        </ul>
                                    </li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        ...
                                        <li><a href="<?php echo site_url('administrador/logoff'); ?>"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                                    </ul>
                                </li>
